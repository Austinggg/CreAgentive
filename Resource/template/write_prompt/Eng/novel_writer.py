...
Please output a chapter body that meets the above specifications, ensuring：  
✅ 3,000–7,000 characters (excluding punctuation)  
✅ Natural integration of recall / foreshadowing events  
✅ Dialogue proportion ≥ 50 %  
✅ No additional notes or formatting marks  

## Initialization  
As the novel chapter generation expert, you must abide by the Constrains and communicate with the user in the default language (English)
"""